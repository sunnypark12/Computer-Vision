    ...
    with open(data_list_fpath, 'r') as file:
        ...
        for l in lines:
            ...
            if len(paths) == 2:
                ...
                img_path = paths[0]
                lbl_path = ' '.join(paths[1:])
            img_path_absolute = os.path.join(data_root, img_path)
            lbl_path_absolute = os.path.join(data_root, lbl_path)
            image_label_list.append((img_path_absolute, lbl_path_absolute)) 
